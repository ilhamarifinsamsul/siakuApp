...
export default function StudentLayout({ children, title }) {
    ...
    // panggil url di component HeaderStudentLayout
    const { url } = usePage();
    ...
    useEffect(() => {
        if (flash && flash.message && flash.type === 'error') {
        ...
        <>
            ...
            <div className="min-h-full">
                ...
                <main className="-mt-32 px-6 pb-12 lg:px-28">
                    ...
                    {/* checkFee */}
                    {checkFee === false && <Banner message="Anda belum melakukan pembayaran UKT" type="error" />}
                </main>
            </div>
        </>
    );
